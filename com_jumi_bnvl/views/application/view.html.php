...
if(JV == 'j2') {
	...
	class JumiViewApplication extends JView {
	    function display($tpl = null) {
			...
			echo $noscript = '<noscript><strong>JavaScript is currently disabled.</strong>Please enable it for a better experience of this page.</noscript>';
	        parent::display($tpl);
	    }
	}
}
	...
	class JumiViewApplication extends JViewLegacy {
		function display($tpl = null) {
			...
			echo $noscript = '<noscript><strong>JavaScript is currently disabled.</strong>Please enable it for a better experience this page.</noscript>';
			parent::display($tpl);
		}
	}
}